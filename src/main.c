...
void status_personagem(PERSONAGEM personagem){
    printf("Nome:%s\nLevel:%i\nHP:%i/%i\nAtaque:%i\nDefesa:%i\nPontos:%i\nAndamento:%i", personagem.nome,personagem.LEVEL, personagem.HP,personagem.HPMAX, personagem.ATK, personagem.DEF, personagem.pontos, personagem.posicao);
}
